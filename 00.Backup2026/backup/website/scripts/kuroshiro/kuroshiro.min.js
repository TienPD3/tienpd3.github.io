...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _regenerator=require("babel-runtime/regenerator"),_regenerator2=_interopRequireDefault(_regenerator),_createClass=function(){function r(r,a){for(var e=0;e<a.length;e++){var t=a[e];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(r,t.key,t)}}return function(a,e,t){return e&&r(a.prototype,e),t&&r(a,t),a}}(),_util=require("./util");function _interopRequireDefault(r){return r&&r.__esModule?r:{default:r}}function _asyncToGenerator(r){return function(){var a=r.apply(this,arguments);return new Promise(function(r,e){return function t(n,i){try{var o=a[n](i),u=o.value}catch(r){return void e(r)}if(!o.done)return Promise.resolve(u).then(function(r){t("next",r)},function(r){t("throw",r)});r(u)}("next")})}}function _classCallCheck(r,a){if(!(r instanceof a))throw new TypeError("Cannot call a class as a function")}var Kuroshiro=function(){function r(){_classCallCheck(this,r),this._analyzer=null}return _createClass(r,[{key:"init",value:function(){var r=_asyncToGenerator(_regenerator2.default.mark(function r(a){var e;return _regenerator2.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(null!=(e=this)._analyzer){r.next=13;break}return r.prev=2,r.next=5,a.init();case 5:e._analyzer=a,r.next=11;break;case 8:throw r.prev=8,r.t0=r.catch(2),r.t0;case 11:r.next=14;break;case 13:throw new Error("Kuroshiro has already been initialized.");case 14:case"end":return r.stop()}},r,this,[[2,8]])}));return function(a){return r.apply(this,arguments)}}()},{key:"convert",value:function(){var r=_asyncToGenerator(_regenerator2.default.mark(function r(a,e){var t,n,i,o,u,s,l,f,c,_,m,d,g,p,h,k,b,w,y,j,x,K,R,v,T,S,E,H,O,I;return _regenerator2.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if((e=e||{}).to=e.to||"hiragana",e.mode=e.mode||"normal",e.romajiSystem=e.romajiSystem||_util.ROMANIZATION_SYSTEM.HEPBURN,e.delimiter_start=e.delimiter_start||"(",e.delimiter_end=e.delimiter_end||")",a=a||"",-1!==["hiragana","katakana","romaji"].indexOf(e.to)){r.next=9;break}throw new Error("Invalid Target Syllabary.");case 9:if(-1!==["normal","spaced","okurigana","furigana"].indexOf(e.mode)){r.next=11;break}throw new Error("Invalid Conversion Mode.");case 11:if(-1!==Object.keys(_util.ROMANIZATION_SYSTEM).map(function(r){return _util.ROMANIZATION_SYSTEM[r]}).indexOf(e.romajiSystem)){r.next=14;break}throw new Error("Invalid Romanization System.");case 14:return r.next=16,this._analyzer.parse(a);case 16:for(t=r.sent,n=0;n<t.length;n++)(0,_util.hasJapanese)(t[n].surface_form)?t[n].reading?(0,_util.hasHiragana)(t[n].reading)&&(t[n].reading=(0,_util.toRawKatakana)(t[n].reading)):t[n].surface_form.split().every(_util.isKana)?t[n].reading=(0,_util.toRawKatakana)(t[n].surface_form):t[n].reading=t[n].surface_form:t[n].reading=t[n].surface_form;if("normal"!==e.mode&&"spaced"!==e.mode){r.next=35;break}r.t0=e.to,r.next="katakana"===r.t0?22:"romaji"===r.t0?25:"hiragana"===r.t0?28:32;break;case 22:if("normal"!==e.mode){r.next=24;break}return r.abrupt("return",t.map(function(r){return r.reading}).join(""));case 24:return r.abrupt("return",t.map(function(r){return r.reading}).join(" "));case 25:if("normal"!==e.mode){r.next=27;break}return r.abrupt("return",t.map(function(r){return(0,_util.toRawRomaji)(r.reading,e.romajiSystem)}).join(""));case 27:return r.abrupt("return",t.map(function(r){return(0,_util.toRawRomaji)(r.reading,e.romajiSystem)}).join(" "));case 28:for(i=0;i<t.length;i++)if((0,_util.hasKanji)(t[i].surface_form))if((0,_util.hasKatakana)(t[i].surface_form)){for(t[i].reading=(0,_util.toRawHiragana)(t[i].reading),o="",u="",s=0;s<t[i].surface_form.length;s++)(0,_util.isKanji)(t[i].surface_form[s])?u+="(.*)":u+=(0,_util.isKatakana)(t[i].surface_form[s])?(0,_util.toRawHiragana)(t[i].surface_form[s]):t[i].surface_form[s];if(l=new RegExp(u),f=l.exec(t[i].reading)){for(c=0,_=0;_<t[i].surface_form.length;_++)(0,_util.isKanji)(t[i].surface_form[_])?(o+=f[c+1],c++):o+=t[i].surface_form[_];t[i].reading=o}}else t[i].reading=(0,_util.toRawHiragana)(t[i].reading);else t[i].reading=t[i].surface_form;if("normal"!==e.mode){r.next=31;break}return r.abrupt("return",t.map(function(r){return r.reading}).join(""));case 31:return r.abrupt("return",t.map(function(r){return r.reading}).join(" "));case 32:throw new Error("Unknown option.to param");case 33:r.next=73;break;case 35:if("okurigana"!==e.mode&&"furigana"!==e.mode){r.next=73;break}m=[],d=0;case 38:if(!(d<t.length)){r.next=62;break}t[d].reading=(0,_util.toRawHiragana)(t[d].reading),g=(0,_util.getStrType)(t[d].surface_form),r.t1=g,r.next=0===r.t1?44:1===r.t1?46:2===r.t1?54:3===r.t1?56:58;break;case 44:return m.push([t[d].surface_form,1,t[d].reading]),r.abrupt("break",59);case 46:for(p="",h=!1,k=[],b=0;b<t[d].surface_form.length;b++)(0,_util.isKanji)(t[d].surface_form[b])?h?k[k.length-1]+=t[d].surface_form[b]:(h=!0,p+="(.*)",k.push(t[d].surface_form[b])):(h=!1,k.push(t[d].surface_form[b]),p+=(0,_util.isKatakana)(t[d].surface_form[b])?(0,_util.toRawHiragana)(t[d].surface_form[b]):t[d].surface_form[b]);if(w=new RegExp("^"+p+"$"),y=w.exec(t[d].reading))for(j=1,x=0;x<k.length;x++)(0,_util.isKanji)(k[x][0])?m.push([k[x],1,y[j++]]):m.push([k[x],2,(0,_util.toRawHiragana)(k[x])]);else m.push([t[d].surface_form,1,t[d].reading]);return r.abrupt("break",59);case 54:for(K=0;K<t[d].surface_form.length;K++)m.push([t[d].surface_form[K],2,t[d].reading[K]]);return r.abrupt("break",59);case 56:for(R=0;R<t[d].surface_form.length;R++)m.push([t[d].surface_form[R],3,t[d].surface_form[R]]);return r.abrupt("break",59);case 58:throw new Error("Unknown strType");case 59:d++,r.next=38;break;case 62:v="",r.t2=e.to,r.next="katakana"===r.t2?66:"romaji"===r.t2?68:"hiragana"===r.t2?70:72;break;case 66:if("okurigana"===e.mode)for(T=0;T<m.length;T++)1!==m[T][1]?v+=m[T][0]:v+=m[T][0]+e.delimiter_start+(0,_util.toRawKatakana)(m[T][2])+e.delimiter_end;else for(S=0;S<m.length;S++)1!==m[S][1]?v+=m[S][0]:v+="<ruby>"+m[S][0]+"<rp>"+e.delimiter_start+"</rp><rt>"+(0,_util.toRawKatakana)(m[S][2])+"</rt><rp>"+e.delimiter_end+"</rp></ruby>";return r.abrupt("return",v);case 68:if("okurigana"===e.mode)for(E=0;E<m.length;E++)1!==m[E][1]?v+=m[E][0]:v+=m[E][0]+e.delimiter_start+(0,_util.toRawRomaji)(m[E][2],e.romajiSystem)+e.delimiter_end;else{for(v+="<ruby>",H=0;H<m.length;H++)v+=m[H][0]+"<rp>"+e.delimiter_start+"</rp><rt>"+(0,_util.toRawRomaji)(m[H][2],e.romajiSystem)+"</rt><rp>"+e.delimiter_end+"</rp>";v+="</ruby>"}return r.abrupt("return",v);case 70:if("okurigana"===e.mode)for(O=0;O<m.length;O++)1!==m[O][1]?v+=m[O][0]:v+=m[O][0]+e.delimiter_start+m[O][2]+e.delimiter_end;else for(I=0;I<m.length;I++)1!==m[I][1]?v+=m[I][0]:v+="<ruby>"+m[I][0]+"<rp>"+e.delimiter_start+"</rp><rt>"+m[I][2]+"</rt><rp>"+e.delimiter_end+"</rp></ruby>";return r.abrupt("return",v);case 72:throw new Error("Invalid Target Syllabary.");case 73:case"end":return r.stop()}},r,this)}));return function(a,e){return r.apply(this,arguments)}}()}]),r}(),Util={isHiragana:_util.isHiragana,isKatakana:_util.isKatakana,isKana:_util.isKana,isKanji:_util.isKanji,isJapanese:_util.isJapanese,hasHiragana:_util.hasHiragana,hasKatakana:_util.hasKatakana,hasKana:_util.hasKana,hasKanji:_util.hasKanji,hasJapanese:_util.hasJapanese,kanaToHiragna:_util.kanaToHiragna,kanaToKatakana:_util.kanaToKatakana,kanaToRomaji:_util.kanaToRomaji};Kuroshiro.Util=Util,exports.default=Kuroshiro,module.exports=exports.default;
